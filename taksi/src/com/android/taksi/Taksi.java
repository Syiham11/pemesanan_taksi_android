...
public class Taksi extends Activity {
	...
	private String sendTanggal,status,sendWaktu;
	...
	private boolean isDateAfter(DatePicker tempView) {
        ...
        if(tempCalendar.after(mCalendar))
            return true;
        		...
        		new AlertDialog.Builder(Taksi.this)

        		.setTitle("Maaf Anda Salah Input!")

        		.setMessage("Tanggal Inputan Anda Harus Setelah Tanggal Sekarang")
	...
	private TimePickerDialog.OnTimeSetListener setWaktu = new OnTimeSetListener() {
		...
		public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
			...
			sendWaktu = Integer.toString(hourOfDay) + ":"
					+ Integer.toString(minute);
		}
	};
	...
	public void postRequest() {
		...
		try {
			...
			post.add(new BasicNameValuePair("jumlah", jumlah.getText()
					.toString()));
			post.add(new BasicNameValuePair("phoneid",uid));
